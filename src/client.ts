...
export class SvelteApolloClient<T> extends ApolloClient<T> {
	...
	public _query<TData = unknown, TVariables = unknown>(
		query: DocumentNode,
	...
	public _mutate<T = unknown, TVariables = unknown>(
	...
	public _restore<TData = unknown, TVariables = OperationVariables>(
		query: DocumentNode,
	...
	public _subscribe<TData = unknown, TVariables = unknown>(
		query: DocumentNode,
